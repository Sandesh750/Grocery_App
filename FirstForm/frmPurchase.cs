    ...
    public partial class frmPurchase : Form
    {
        ...
        private void frmPurchase_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                GlobalClass.pbillNo = Convert.ToString(GlobalClass.id_Resder("select PBillNo from Purchase"));
                txPBillNo.Text = GlobalClass.pbillNo;
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tempAmount = Convert.ToInt32(lstAmount.SelectedItem);
                txTotalBill.Text = Convert.ToString(Convert.ToInt32(txTotalBill.Text) - tempAmount);
                txDiscount.Text = Convert.ToString((Convert.ToInt32(txTotalBill.Text) * 5) / 100);
                txNet.Text = Convert.ToString(Convert.ToInt32(txTotalBill.Text) - Convert.ToInt32(txDiscount.Text));
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (optCash.Checked == true)
                {
                    ...
                    GlobalClass.PTrNo = Convert.ToString(GlobalClass.id_Resder("Select TrNo From Cash"));

                    GlobalClass.Balance = Convert.ToString(Convert.ToInt32(GlobalClass.Balance) - Convert.ToInt32(txNet.Text));

                    GlobalClass.record_Manip("Insert into cash values ('" + GlobalClass.PTrNo + "','" + dtpDate.Text + "',0,'" + txNet.Text + "','" + GlobalClass.Balance + "','Purchase')");
                }
                else
                {
                ...
                GlobalClass.record_Manip("Insert into Purchase Values ('" + GlobalClass.pbillNo + "','" + dtpDate.Text + "','" + cmbSuppNo.Text + "','" + GlobalClass.lsticode + "' , '" + GlobalClass.lstiname + "','" + GlobalClass.lstprice + "','" + GlobalClass.lstqty + "','" + GlobalClass.lstamount + "','" + txTotalBill.Text + "','" + txDiscount.Text + "','" + txNet.Text + "','" + GlobalClass.PayMode + "')");
